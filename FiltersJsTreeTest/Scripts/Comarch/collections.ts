...
// ReSharper disable once Lambda
    ...
    export class Dictionary<K, V>{
         ...
         * @private
         */
        table: { [key: string]: IDictionaryPair<K, V> };
        ...
        */
        ...
        //TODO DK move to utils
        static ConvertObjectToDictionary<K, V>(obj: Object): Dictionary<K,V> {
            var dict = new Dictionary<K, V>();
            if (obj && !jQuery.isEmptyObject(obj))
            for (var key in obj) {
                dict.setValue(<any>key, obj[key]);
            }
            return dict;
        }
        static ConvertDictionaryToObject<K, V>(dictionary: Dictionary<K, V>):any {
            var result = {};
            if (dictionary && !jQuery.isEmptyObject(dictionary))
            dictionary.forEach((key:any, val) => {
                result[key] = val;
            });
            return result;
        }
        ...
        static FromObjectDictionaryToDictionary<TInKeyType, TInValueType, TOutKeyType, TOutValueType>(
            obj: { [key: string]: TInValueType },
            keySelector: (obj: string) => TOutKeyType,
            valueSelector: (obj: TInValueType) => TOutValueType,
            getHashCodeSelector?: (key: TOutKeyType) => string,
            dictionaryInstanceCreator: (getHashCodeSelector?: (key: TOutKeyType) => string) => Dictionary<TOutKeyType, TOutValueType> = null
        ): Dictionary<TOutKeyType, TOutValueType> {

            var dict: Dictionary<TOutKeyType, TOutValueType> = null;
            if (dictionaryInstanceCreator) {
                dict = dictionaryInstanceCreator();
            } else {
                dict = new Dictionary<TOutKeyType, TOutValueType>(getHashCodeSelector);
            }
            if (!obj) return dict;
        ...
        static FromObjectToDictionary<TInObject extends Object, TOutKeyType, TOutValueType>(
            obj: TInObject,
            keySelector: (obj: string) => TOutKeyType,
            valueSelector: (obj: TInObject) => TOutValueType,
            getHashCodeSelector?: (key: TOutKeyType) => string): Dictionary<TOutKeyType, TOutValueType> {
            var dict = new Dictionary<TOutKeyType, TOutValueType>(getHashCodeSelector);
            if (!obj) return dict;
            Object.keys(obj).forEach((key: string) => {
                var value = obj[key];
                dict.setValue(keySelector(key), valueSelector(value));
        ...
        static FromArrayLikeObjectToDictionary<TInKeyType,TInValueType,TOutKeyType , TOutValueType>(obj: {[key:number]:TInValueType },keySelector:(obj:string)=>TOutKeyType,valueSelector:(obj:TInValueType)=>TOutValueType,getHashCodeSelector?: (key: TOutKeyType) => string): Dictionary<TOutKeyType, TOutValueType> {
            return Dictionary.FromObjectDictionaryToDictionary(obj, keySelector, valueSelector, getHashCodeSelector);
        }

        static FromDictionaryToObject<TInKeyType,TInValueType,TOutKeyType, TOutValueType>(dict: Dictionary<TInKeyType,TInValueType>,keySelector:(obj:TInKeyType)=>string,valueSelector:(obj:TInValueType)=>TOutValueType): {[key:string]:TOutValueType} {
            var result = {};
        ...
        static GetCopy<K, V>(dictionary: Dictionary<K, V>,deepCopyFunction:(o:V)=>V=o=>o): Dictionary<K, V> {
    ...
    export class Stack<T> {
        ...
        /**
          * Removes element from this stack.
          * This method isn't standard method in stack implementation 
          * Added by K.M. Comarch  
          * @param item 
